...
@section('content')
            ...
            <div class="page-title-breadcrumb pull-left">                
                <ol class="breadcrumb page-breadcrumb ">
                    ...
                    <li><a class="parent-item" href="{{route('user.index')}}">Employees</a>&nbsp;<i
                            class="fa fa-angle-right"></i>
                    </li>
            ...
            <div class="row">              
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="employee_id" required placeholder="Enter Employee ID" id="exampleInputEmail"
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="firstname" required placeholder="Enter First Name" id="exampleInputEmail"
                             ...
                             <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="lastname" required placeholder="Enter Last Name" id="exampleInputEmail"
                             ...
                             <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="email" name="email" required placeholder="Enter Email Address" id="exampleInputEmail"
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="contact_number" required placeholder="Enter Contact Number" id="exampleInputEmail"
