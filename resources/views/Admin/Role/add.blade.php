...
@section('content')
            ...
            <div class="page-title-breadcrumb pull-left">                
                <ol class="breadcrumb page-breadcrumb ">
                    ...
                    <li><a class="parent-item" href="{{route('role.index')}}">Roles</a>&nbsp;<i
                            class="fa fa-angle-right"></i>
                    </li>
        ...
        <div class="card-body p-0 border-0 shadow-lg">
            ...
            <form class="user" method="post" action="{{route('role.store')}}" enctype="multipart/form-data"> 
             @csrf
            <div class="row">              
                <div class="col-md-12">
                    <div class="p-4">                  
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea type="password" name="description" required placeholder="Enter Role Description" id="exampleInputText"
