            ...
            <div class="col-md-12">
                <div class="p-4">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="name" required placeholder="Enter Department Name"
                                id="exampleInputUser" class="form-control   @error('name') is-invalid @enderror"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="code" required placeholder="Enter Department Code"
                                id="exampleInputUser" class="form-control   @error('code') is-invalid @enderror"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="shortname" required placeholder="Enter Department Short Name"
                                id="exampleInputUser" class="form-control   @error('shortname') is-invalid @enderror"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea type="password" name="description" required
                                placeholder="Enter Department Description" id="exampleInputText"
