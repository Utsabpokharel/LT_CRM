...
<div class="card-body p-0 border-0 shadow-lg">
    ...
    <form class="user" method="post" action="{{route('todo.update',$todo->id)}}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="file" name="fileUpload" id="exampleInputEmail"
                                ...
                                value="{{old('fileUpload',$todo->fileUpload)}}" />
                            @error('fileUpload')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control  @error('task_priority') is-invalid @enderror"
                                name="task_priority">
                                <option value="{{$todo->task_priority}}" selected>{{$todo->task_priority}}</option>
                                <option class="bg-info" disabled>-----Select Task Priority-----</option>
