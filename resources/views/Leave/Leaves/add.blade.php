...
<div class="card-body p-0 border-0 shadow-lg">
    ...
    <form class="leave" method="post" action="{{route('leave.store')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="p-4">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select class="form-control  @error('leave_type') is-invalid @enderror" name="leave_type"
                                ...
                                <option value="{{old('leave_type','')}}" disabled selected>-----Select Leave Type-----
                                </option>
        ...
        <div class="form-actions p-3">
            <div class="row">
                <div class="offset-md-3 col-md-9">
                    <button type="submit" class="btn btn-success m-r-20">Apply</button>
