...
<div class="card-body p-0 border-0 shadow-lg">
    ...
    <form class="user" method="post" action="{{route('expense.update',$expense->id)}}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="particular" required placeholder="Enter Expense Pariculars"
                                ...
                                value="{{old('particular',$expense->particular)}}" />
                            @error('particular')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control  @error('mode') is-invalid @enderror" name="mode">
                                ...
                                <option value="Cash" @if($expense->mode=='Cash') selected @endif>Cash</option>
                                <option value="Cheque" @if($expense->mode=='Cheque') selected @endif>Cheque</option>
                                <option value="Bank Transfer" @if($expense->mode=='Bank Transfer') selected @endif>Bank
                                    Transfer
                                </option>
                                <option value="QR Pay" @if($expense->mode=='QR Pay"') selected @endif>QR Pay</option>
                                <option value="Wallet Transfer" @if($expense->mode=='Wallet Transfer') selected
                                    @endif>Wallet
                                    Transfer</option>
                                <option value="Others" @if($expense->mode=='Others') selected @endif>Others</option>
                            </select>
                            @error('mode')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea name="remarks" required placeholder="Enter Expense Remarks" id="exampleInputEmail"
                                class="form-control  @error('remarks') is-invalid @enderror">{{old('remarks',$expense->remarks)}}</textarea>
                            @error('remarks')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
