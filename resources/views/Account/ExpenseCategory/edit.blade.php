...
<div class="card-body p-0 border-0 shadow-lg">
    ...
    <form class="user" method="post" action="{{route('expensecategory.update',$exp_category->id)}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="categoryname" required placeholder="Enter Expense Category Name"
                                ...
                                value="{{old('categoryname',$exp_category->categoryname)}}" />
                            @error('categoryname')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="category_id" required placeholder="Enter Expense Category Code"
                                ...
                                value="{{old('category_id',$exp_category->category_id)}}" />
                            @error('category_id')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea type="password" name="description" required
                                ...
                                class="form-control  @error('description') is-invalid @enderror">{{old('description',$exp_category->description)}}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
